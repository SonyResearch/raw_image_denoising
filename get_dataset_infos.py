...
SonyCCM = np.array(
    [[1.9712269, -0.6789218, -0.29230508], [-0.29104823, 1.748401, -0.45735288], [0.02051281, -0.5380369, 1.5175241]]
)
...
def get_IMX686_info_short(info_dir="infos", root_dir="/data/LRID", subset="indoor_x5"):
...
def get_IMX686_info_long(info_dir="infos", root_dir="/data/LRID", subset="indoor_x5", GTtype="GT_align_ours"):
